...
public class SolrDocumentIterator extends AbstractDocumentIterator<String>
{
    ...
    private SolrQuery getQuery() throws SolrIndexerException
    {
        if (query == null) {
            ...
            query.setFields(FieldUtils.WIKI, FieldUtils.DOCUMENT_PARENT_PATH, FieldUtils.DOCUMENT_NAME,
                FieldUtils.DOCUMENT_FINAL, FieldUtils.DOCUMENT_LOCALE, FieldUtils.VERSION);
