...
public class SolrReferenceResolverTest
{
    ...
    {
        Assert.assertEquals("wiki:wiki1 AND docParentPath_exact:space11.data",
    ...
    {
        Assert.assertEquals(
            "wiki:wiki1 AND docParentPath_exact:space11.data AND docName_exact:class111 AND docFinal:true",
    ...
    {
        Assert.assertEquals("wiki:wiki1"
            + " AND docParentPath_exact:space12.code AND docName_exact:document122 AND docFinal:true"
